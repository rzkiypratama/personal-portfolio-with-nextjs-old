    ...
    <div className='h-screen relative flex overflow-hidden flex-col text-left md:flex-row max-w-full justify-evenly items-center mx-auto z-0'>
      ...
      <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80'>
        ...
        >
          ...
          <button
            onClick={handlePrev}
            className='lg:block hidden absolute left-0 top-1/2 transform -translate-y-1/2 p-2 bg-gray-300'
          >
            Prev
          </button>
          <button
            onClick={handleNext}
            className='lg:block hidden absolute right-0 top-1/2 transform -translate-y-1/2 p-2 bg-gray-300'
          >
            Next
          </button>
        </motion.div>
